...
export const en: TranslationDictionary = {
  ...
  rateLastUpdated: "Rate last changed",
  enteringPricesIn: "Prices you type now are in",
  savedAtRate: "saved at rate",
  rateCheckTitle: "Check this rate",
  rateCheckBody: "You changed the rate from",
  rateCheckTo: "to",
  rateCheckQuestion: "Is that right? A wrong rate makes all your prices wrong.",
  rateCheckFix: "No, let me fix it",
  rateCheckConfirm: "Yes, that is correct",
  rateStaleTitle: "Is your rate still correct?",
  rateStaleBody: "Your ZWL rate is from",
  rateStaleNever: "You have not set today's ZWL rate yet.",
  updateRateNow: "Update rate",
  dismissForToday: "Not now",
  realProfitUsd: "In US dollars today",
  rateMovedNote: "The rate moved since you bought this stock. Your real profit is shown above in US dollars.",
  ...
  searchProductsAndBrands: "Search products and brands",
  locationPlaceholder: "Location (e.g. city, area)",
  supplierNamePlaceholder: "Supplier name",
  sortByNameAZ: "Name (A-Z)",
  sortByPriceLowHigh: "Price (Low to High)",
