...
export const sn: TranslationDictionary = {
  ...
  rateLastUpdated: "Chiyero chakachinjwa",
  enteringPricesIn: "Mitengo yauri kunyora iri mu",
  savedAtRate: "yachengetwa pachiyero",
  rateCheckTitle: "Tarisa chiyero ichi",
  rateCheckBody: "Wachinja chiyero kubva pa",
  rateCheckTo: "kuenda pa",
  rateCheckQuestion: "Ndizvo here? Chiyero chisiri icho chinokanganisa mitengo yako yose.",
  rateCheckFix: "Kwete, ndogadzirisa",
  rateCheckConfirm: "Hongu, ndizvo",
  rateStaleTitle: "Chiyero chako chichiri icho here?",
  rateStaleBody: "Chiyero cheZWL ndechemusi wa",
  rateStaleNever: "Hausati waisa chiyero cheZWL cha nhasi.",
  updateRateNow: "Gadzirisa chiyero",
  dismissForToday: "Kwete izvozvi",
  realProfitUsd: "MuUS dollars nhasi",
  rateMovedNote: "Chiyero chakachinja kubva pawakatenga. Purofiti yako chaiyo iri pamusoro muUS dollars.",
