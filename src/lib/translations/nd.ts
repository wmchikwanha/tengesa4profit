...
export const nd: TranslationDictionary = {
  ...
  rateLastUpdated: "Isilinganiso sitshintshwe",
  enteringPricesIn: "Amanani owafakayo akhona nge",
  savedAtRate: "agcinwe ngesilinganiso",
  rateCheckTitle: "Hlola lesi silinganiso",
  rateCheckBody: "Utshintshe isilinganiso kusuka ku",
  rateCheckTo: "kuya ku",
  rateCheckQuestion: "Kulungile yini? Isilinganiso esingalunganga sonakalisa wonke amanani akho.",
  rateCheckFix: "Hatshi, ake ngilungise",
  rateCheckConfirm: "Yebo, kulungile",
  rateStaleTitle: "Isilinganiso sakho sisalungile yini?",
  rateStaleBody: "Isilinganiso se-ZWL ngesosuku",
  rateStaleNever: "Kawukafaki isilinganiso se-ZWL sanamuhla.",
  updateRateNow: "Lungisa isilinganiso",
  dismissForToday: "Hatshi khathesi",
  realProfitUsd: "Ngama-US dollars lamuhla",
  rateMovedNote: "Isilinganiso sitshintshile kusukela uthenga. Inzuzo yakho yeqiniso itshengiswe ngenhla ngama-US dollars.",
  ...
  searchProductsAndBrands: "Funa imikhiqizo lamabhulandi",
  locationPlaceholder: "Indawo (isib. idolobho, indawo)",
  supplierNamePlaceholder: "Ibizo lomthengisi",
  sortByNameAZ: "Ibizo (A-Z)",
  sortByPriceLowHigh: "Intengo (Ephansi kuya Ephezulu)",
